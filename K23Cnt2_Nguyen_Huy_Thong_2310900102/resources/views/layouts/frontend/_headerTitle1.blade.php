  ...
  <div class="header bg-gradient-to-r from-purple-500 to-pink-500">
    ...
    <div class="container mx-auto">
      ...
      <div class="flex justify-between items-center py-2 text-sm">
        <div>
          <a class="mr-4 hover:underline" href="{{route('nhtuser.home1')}}">Trang Chủ</a>
      ...
      <div class="flex items-center py-4">
        <div class="flex items-center">
          <a href="{{route('nhtuser.home1')}}"><img alt=" logo" class="mr-2" height="40" src="/storage/img/san_pham/logoT.png" width="40"/></a>
